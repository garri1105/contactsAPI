...
import inkit_test.app
import inkit_test.contacts
...
def client(mock_store):
    api = inkit_test.app.create_app(mock_store)
...
def test_list_images(client):
    doc = {
        'contacts': [
            {
                'href': '/contacts/1eaf6ef1-7f2d-4ecc-a8d5-6e8adba7cc0e.png'
            }
        ]
    }
...
def test_saving_image(monkeypatch):
    ...
    store = inkit_test.contacts.ImageStore(
        storage_path,
